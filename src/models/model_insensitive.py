...
def build_model_insensi(Stations, OilSpills, Resources, Vehicles, W,
                v_o, eta_o, t_os, gamma, M, demand_or, demand_ov, L_p_or,
                NumberStMax, A_sr, nH, nUN, nQ, Q_vr, n_vs,
                F_s, C_r, Eff_sor, pn_sor, c_v, Distance, DistanceMax, model_name, insensitive=False):
    ...
    # ------------- Constraint 10 is relaxed to demonstrate the utility of LAMOSCAD covering highly-sensitive oil spills
    # Constraint 10
    # for o in OilSpills:
    #     model.addConstr(
...
def solve_model_insensi(model, x_s, y_os, z_sor, h_sov, OilSpills, needMultiSolutions=False, uncertaintyEvaluation=False,
                ):
