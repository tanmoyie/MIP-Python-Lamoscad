...
"""
def plot_parallel_coordinate_plot(df_fig8):

    fig, ax = plt.subplots(figsize=(2,3))
    kwargs = {'lw':0.6} #'alpha':1,
    ax = pd.plotting.parallel_coordinates(data_coverage_sorted, class_column='coverage_percentage',
                                     cols=['w1', 'w2', 'w3'],
    ...
    fig, ax = plt.subplots(figsize=(2,3))
    kwargs = {'lw':0.6} #'alpha':1,
    ax = pd.plotting.parallel_coordinates(data_MeanResponseTime_sorted, class_column='MeanResponseTime',
                                     cols=['w1', 'w2', 'w3'],
    ...
    fig, ax = plt.subplots(figsize=(2,3))
    kwargs = {'lw':0.6} #'alpha':1,
    ax = pd.plotting.parallel_coordinates(data_costObj2_sorted, class_column='objValues2',
                                     cols=['w1', 'w2', 'w3'],
                                     colormap=plt.get_cmap('hot'),axvlines=False,
                                     **kwargs                      )
    plt.yscale("log")
